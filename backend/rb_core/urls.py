...
urlpatterns = [
    path('', home, name='home'),
    path('robots.txt', api_robots_txt, name='api_robots_txt'),
    ...
    path('api/book-projects/<int:pk>/republish/', RepublishBookView.as_view(), name='republish_book'),
